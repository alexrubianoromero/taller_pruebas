		...
		$fechapan = date ( "Y/m/j");
			...
			*/	
				...
				if($_GET['control']==1)
				{
					...
					$sql_caja = "select numero_factura as documento,fecha,placa,total_factura  as total from $tabla11 where  fecha =  '".$fechapan."'    and id_empresa = '".$_SESSION['id_empresa']."' order by id_factura  ";
					$sql_total_factura = "select sum(total_factura) as suma from  $tabla11   where  fecha =  '".$fechapan."'    and id_empresa = '".$_SESSION['id_empresa']."'";
