...
<table width="90%" border="1">
  ...
  <tr>
    ...
    <td><h7><div align = "right"><?php  echo number_format($datos[0]['subtotalfac'], 0, ',', '.') ?></div></h7></td>
  </tr>
  <?php
  ...
  <tr>
    ...
    <td><h7><div align = "right">
      <?php  echo number_format($datos[0]['ivafac'], 0, ',', '.') ;
	  	  ?>
    </div></h7></td>
  </tr>
  <tr>
    <td colspan="2"><h7>RETENCION</h7></td>
    <td><h7><div align ="right"  ><?php  echo number_format($datos[0]['retefuentefac'], 0, ',', '.')   ?></div></h7></td>
  </tr>
  <tr>
    <td colspan="2"><h7>TOTAL</h7></td>
    <td><h7><div align = "right"><?php  echo number_format($datos[0]['totalfac'], 0, ',', '.')  ?></div></h7></td>
  </tr>
  <tr>
    <td colspan="2" rowspan="4"><h7><?php echo $nombre_empresa;  ?></h7> </td>
