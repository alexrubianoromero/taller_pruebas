...
<?php
$sql_movimientos = "select fecha_movimiento , cantidad,observaciones,facturacompra,id_factura_venta,id_codigo_producto  from $tabla19 where id_codigo_producto = '".$_GET['id_codigo']."' and id_empresa = '".$_SESSION['id_empresa']."'  and anulado < 1  order by fecha_movimiento ";
