...
item.no_factura  from $tabla15  item 
...
//exit();
$sql_eliminar_items = "delete from  $tabla15  where id_item = '".$_POST['eliminar_']."'";
...
where  codigo_producto = '".$cantidades['codigo']."'  and id_empresa = '2'  "; 
