...
$sql_grabar_orden = "insert into $tabla14 (orden,placa,sigla,fecha,observaciones,radio,antena,repuesto,herramienta,otros,
	...
	iva,id_empresa,estado,kilometraje,mecanico,tipo_orden) 
...
//////////////////////////ahora ordenes_traz   de respaldo/////////////////////////////////////

$sql_grabar_orden_traz = "insert into $tabla31 (orden,placa,sigla,fecha,observaciones,radio,antena,repuesto,herramienta,otros,
...
$consulta_grabar_ordenes_traz = mysql_query($sql_grabar_orden_traz,$conexion);
...
$sql_actualizar_contaor = "update $tabla10 set  contaor = '".$_POST['orden_numero']."'  where   id_empresa = '2' "; 
...
$sql_traer_id_orden = "select max(id) as id  from $tabla14 where placa = '".$_POST['placa']."'   and id_empresa = '2'  ";
...
$sql_traer_items_temporal = "select * from $tabla18    where  no_factura =  '".$_POST['orden_numero']."'   and id_empresa = '2' order by id_item ";
...
while($items  =  mysql_fetch_array($consulta_temporal_definitivo))

		{
			...
			values ('".$id_orden['id']."','".$items[2]."','".$items[3]."','".$items[4]."','".$items[5]."','".$items[7]."','2','0')";
			...
			$sql_valor_existente = "select codigo_producto,cantidad from $tabla12 where codigo_producto =  '".$items[2]."'   and id_empresa = '2'    ";	
...
/*
  ...
  // echo '<br>cantidad item '.$items[4];
			...
			$sql_actualizar_inventario = "update $tabla12 set cantidad = '".$valor_final_inventario."'   
					 ...
					 where codigo_producto = '".$items[2]."'  and id_empresa = '2'  ";
...
////////////////////////////////////////////////////////
		...
		$sql_borrar_temporal = "delete from $tabla18 where id_empresa = '2' ";
