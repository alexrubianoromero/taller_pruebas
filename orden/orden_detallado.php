  ...
  <form action="" method="post">
    <table border = "1" width = "95%">
      <tr>
        ...
        <td colspan="2"><h3>COTIZACION</h3></td>
        <td >
	  ...
	  <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
	  <td>OPERARIO</td>
	  <td><input name="color" type="text" size="20" value = "<? echo $datos[0]['mecanico']  ?>" ></td></tr>
      <tr>
     ...
     while($items = mysql_fetch_array($consulta_items))
			 ...
			 $i++;
    			...
    			<td width="82" align="right">'.number_format($items['valor_unitario'], 0, ',', '.').'</td>
    			<td width="87" align="center">'.$items['cantidad'].'</td>
   			    <td width="85" align="right">'.number_format($items['total_item'], 0, ',', '.').'</td>
   				 <td width="77"></td>
					</tr>
				';
			 ...
			 echo '<tr><td></td><td></td><td></td><td></td><td align="right"><h4>SUBTOTAL</h4></td><td ><h4 align="right">'.number_format($subtotal, 0, ',', '.').'</h4></td><td></td></tr>';
  ?>
      <!--
  <tr>
    <td width="34">&nbsp;</td>
