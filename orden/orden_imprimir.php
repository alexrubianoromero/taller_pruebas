...
<table width="79%" border="0">
  <tr>
    <td colspan="2" rowspan="3"><img src="<?php  echo $ruta_imagen    ?>" width="187" height="61"></td>
    <td colspan="2" align="center"><?php  echo $datos_empresa['nombre']; ?></td>
    <td width="125">&nbsp;</td>
    <td colspan="2">COTIZACION  No </td>
    <td colspan="2"><?php  echo $datos[0]['orden'] ?></td>
    </tr>
  <tr>
    <td colspan="2" align="center" >Nit: <?php  echo $datos_empresa['identi']; ?></td>
    <td>&nbsp;</td>
    <td width="34">&nbsp;</td>
    <td width="124">&nbsp;</td>
    <td width="106">&nbsp;</td>
    ...
    <tr>
    <td colspan="2" align="center" ><?php  echo $datos_empresa['direccion'].''.$datos_empresa['telefonos'] ; ?></td>
    <td>&nbsp;</td>
    <td width="34">&nbsp;</td>
    <td width="124">&nbsp;</td>
    <td width="106">&nbsp;</td>
